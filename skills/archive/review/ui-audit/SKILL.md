...
name: ui-audit
description: >-
  Automated UI audits against UX principles: visual hierarchy, accessibility, cognitive load, navigation.
  Use when: "audit this UI", "check UX", "review interface", "avaliar UI",
  "revisar UX", "análise de interface", "acessibilidade".
author: Tommy Geoco
