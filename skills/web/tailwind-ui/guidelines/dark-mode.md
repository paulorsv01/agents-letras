...
- Produce real dark-mode image files through the project's image pipeline, or ask the user to supply dark variants; never ship CSS filters as the final treatment
