...
### Step 2. Migrate Kotlin Multiplatform projects to the AGP 9 layout.

If the project uses Kotlin Multiplatform, migrate Android KMP code before
cleaning up the general Android DSL. See [Kotlin Multiplatform on AGP 9](references/kmp.md)
...
4. For KMP projects, the Android app task and shared iOS framework task succeed.
